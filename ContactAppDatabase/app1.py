...
def addUser():
    ...
    if request.method == 'POST':
        ...
        i=database_manager.getId(username)
...
def addContact():
    if request.method == 'POST':
        ...
        database_manager.addContact(i,name, phoneNo, email)
...
def updateContact():
    if request.method == 'POST':
        ...
        if button == "update":
            ...
            name, phoneNo, email = database_manager.searchByName(contactName)
            database_manager.updateContact(i,name, newName, newPhone, newEmail, phoneNo, email)
...
def deleteContact():
    if request.method == 'POST':
        ...
        if button == "delete":
            name, phoneNo, email = database_manager.searchByName(contactName)
            database_manager.deleteContact(i,name, phoneNo, email)
